...
inventory_details_df.loc[~inventory_details_df['upper_bound'].isna(),'days_of_stock_onhand'] = round(inventory_details_df.loc[~inventory_details_df['upper_bound'].isna(),'inventory_on_hand'] / inventory_details_df.loc[~inventory_details_df['upper_bound'],'upper_bound'],0).astype(int)
